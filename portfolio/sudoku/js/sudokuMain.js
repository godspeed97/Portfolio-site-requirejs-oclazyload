(function () {
    ...
    angular.module("sudokuModule")
        .controller("sudokuMainCtrl", sudokuMainCtrl);

    function sudokuMainCtrl(SudokuGridSvc, SudokuModelSvc) {
        ...
        function init() {
            ...
            // event listeners
            document.getElementById("sudokuMenuNav").addEventListener("click", processMenuClick);
            document.getElementById("sudokuMarksMenu").addEventListener("change", MarksDisplayChanged);
            document.getElementById("sudokuOkCancel").addEventListener("click", onOkCancel);
        ...
        function onGridModif(line, col, digit, op) {
            ...
            switch (op) {
                ...
                case SudokuGridSvc.gridOperation.SET:
                ...
                case SudokuGridSvc.gridOperation.UNMARK:
                    if (marksDisplayed === marks.CANDIDATES) {
                ...
                case SudokuGridSvc.gridOperation.MARK:
                    if (marksDisplayed === marks.CANDIDATES) {
        ...
        function processMenuClick(e) {
            ...
            else if (e.target.id === "sudokuInCanonique") {
            ...
            else if (e.target.id === "sudokuReset") {
                grid.loadSudoku(oldPuzzle);
                testAndPlay();
            }

            else if (e.target.id === "sudokuCheck") {
            ...
            else if (e.target.id === "sudokuHints") {
                displayHints();
            }

            else if (e.target.id === "sudokuSolution") {
                displaySolution();
            }

            else if (e.target.id === "sudokuOutCanonique") {
                var result = "";
            ...
            else if (e.target.id === "sudokuAutoPlay") {
                if (checkSudoku()) {
        ...
        function MarksDisplayChanged(e) {
            ...
            var elem = document.getElementById("sudokuMarksNOTES");
            if (elem.checked) {
                ...
                elem = document.getElementById("sudokuMarksNONE");
                if (elem.checked) {
                    grid.showMarks();
                    grid.enableMarksEditing(false);
                    marksDisplayed = marks.NONE;
        ...
        function setDisplayToPlayMode() {
            showMainMenu();
            showSubMenu("sudokuMenuAssistance");
            showSubMenu("sudokuMenuAffichage");
            hideOkCancelMenu();
            showMarksMenu();
            document.getElementById("sudokuMarksNONE").checked = true;
            marksDisplayed = marks.NONE;
        ...
        function setDisplayToInitial() {
            showMainMenu();
            hideSubMenu("sudokuMenuAssistance");
            hideSubMenu("sudokuMenuAffichage");
            hideMarksMenu();
            hideOkCancelMenu();
        ...
        function hideMarksMenu() {
            document.getElementById("sudokuMarksMenu").style.display = "none";
        }
        ...
        function showMarksMenu() {
            document.getElementById("sudokuMarksMenu").style.display = "block";
        }
        ...
        function hideOkCancelMenu() {
            document.getElementById("sudokuOkCancel").style.display = "none";
        }
        ...
        function showOkCancelMenu(okText, cancelText) {
            var text = okText || "OK";
            document.getElementById("sudokuOkBtn").innerHTML = text;
            text = cancelText || "CANCEL";
            document.getElementById("sudokuCancelBtn").innerHTML = text;
            document.getElementById("sudokuOkCancel").style.display = "block";
        }
        ...
        function afficherMessage(message) {
            var dialog = document.getElementById("sudokuDialog");
